    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.mainContent}>
        ...
        <View style={styles.header}>
          ...
          {/* AQUI ESTÁ A MUDANÇA: Usando o componente Image com o caminho do seu logo */}
          <Image
            source={LOGO_PATH} // Use a constante que você ajustou acima
